...
import { openSocialShare } from '../utils/socialShare'
...
export function SharePanel({ title, text, url }: SharePanelProps) {
  ...
  const handlePlatform = (platform: 'x' | 'telegram' | 'reddit') => {
  ...
  return (
    <section className="share-panel">
      ...
      <div className="share-panel__grid">
        <button
          type="button"
          className="share-platform share-platform--x"
        ...
        <button
          type="button"
          className="share-platform share-platform--telegram"
        ...
        <button
          type="button"
          className="share-platform share-platform--reddit"
          onClick={() => handlePlatform('reddit')}
        >
          <RedditIcon />
